    ...
    protected void onHandleIntent(Intent intent) {
        ...
        switch (status) {
            case 1:
                ...
                RemoteViews new_property_expanded = new RemoteViews(this.getPackageName(), R.layout.status_bar_expanded);
                RemoteViews new_property_small = new RemoteViews(this.getPackageName(), R.layout.status_bar);
                ...
                new_property_expanded.setTextViewText(R.id.textView, "How are you feeling today?");
                ...
                Intent notificationIntentNeutral = new Intent(this, ResponseListenerNeutral.class);
                ...
                PendingIntent pendingIntentNeutral = PendingIntent.getBroadcast(this, 0,notificationIntentNeutral, 0);
                new_property_expanded.setOnClickPendingIntent(R.id.ibNotificationNeutral,pendingIntentNeutral);


                Intent notificationIntenthappy = new Intent(this, ResponseListenerHappy.class);
                ...
                PendingIntent pendingIntenthappy = PendingIntent.getBroadcast(this, 0,notificationIntenthappy, 0);
                new_property_expanded.setOnClickPendingIntent(R.id.ibNotificationHappy,pendingIntenthappy);


                Intent notificationIntentSad = new Intent(this, ResponseListenerSad.class);
                ...
                PendingIntent pendingIntentSad = PendingIntent.getBroadcast(this, 0,notificationIntentSad, 0);
                new_property_expanded.setOnClickPendingIntent(R.id.ibNotificationSad,pendingIntentSad);



                Intent intentCancel = new Intent(this, ResponseListenerCancel.class);
                ...
                mNotifyManager.notify(NOTIF_ID, notification1);
                break;
