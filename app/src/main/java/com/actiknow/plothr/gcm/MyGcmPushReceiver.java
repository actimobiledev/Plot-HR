...
public class MyGcmPushReceiver extends GcmListenerService {
    ...
    private com.actiknow.plothr.gcm.NotificationUtils notificationUtils;
...
*/
    ...
    public void onMessageReceived (String from, Bundle bundle) {
        ...
        if (! com.actiknow.plothr.gcm.NotificationUtils.isAppIsInBackground (getApplicationContext ())) {
